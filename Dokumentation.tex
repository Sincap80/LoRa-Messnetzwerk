...
Beim vom HX711 gelesenem Gewicht wird das getarte Gewicht (Tar Funktion/Gewichtnullung) abgezogen und durch eine Kalibrationsvariable (fest codierter Parameter welcher durch ``Trial und Error'' ertestet wird, um Imperfektionen zwischen Wägezellen auszugleichen. In unserem Fall wird ein bekanntes Gewicht auf die Wägezelle gelegt und der Kalibrationswert in Richtung des gesuchten Gewichtes angepasst) dividiert, um einen lesbaren Wert in Kilogramm zu erhalten.
